...
<div class="content">
    ...
    <section class="hero-section">
        <div class="bg-wrap hero-section_bg">
            <div class="bg" data-bg="{{asset('upload/'.$category_detail->banner)}}"></div>
        </div>
        <div class="container">
            ...
            <div class="breadcrumbs-list fl-wrap">
                <a href="{{route('home')}}">Home</a> <span>{{$category_detail->name}}</span>
            </div>
                                ...
                                <div class="list-post-content">
                                    ...
                                    <div class="author-link">
                                        <a href="author-single.html">
                                            <img src="{{asset('home_assets/images/avatar/1.jpg')}}" alt="">
                                                ...
                                                <div class="post-widget-container fl-wrap">
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/1.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">How to
                                                                    start
                                                                    Home
                                                                    education.</a></h4>
                                                            <ul class="pwic_opt">
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/2.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">The secret to
                                                                    moving this
                                                                    screening.</a></h4>
                                                            <ul class="pwic_opt">
                                                                <li><span><i class="far fa-clock"></i> 13 april
                                                                        2021</span></li>
                                                                <li><span><i class="far fa-comments-alt"></i> 6</span>
                                                                </li>
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/3.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">Fall ability to
                                                                    keep Congress
                                                                    on rails.</a></h4>
                                                            <ul class="pwic_opt">
                                        ...
                                        <div class="tab">
                                            <div id="tab-resent" class="tab-content">
                                                <div class="post-widget-container fl-wrap">
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/5.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">Magpie nesting
                                                                    zone
                                                                    sites.</a></h4>
                                                            <ul class="pwic_opt">
                                                                <li><span><i class="far fa-clock"></i> 05 april
                                                                        2021</span></li>
                                                                <li><span><i class="far fa-comments-alt"></i> 16</span>
                                                                </li>
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/6.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">Locals help
                                                                    create whole new
                                                                    community.</a></h4>
                                                            <ul class="pwic_opt">
                                                                <li><span><i class="far fa-clock"></i> 22 march
                                                                        2021</span></li>
                                                                <li><span><i class="far fa-comments-alt"></i> 31</span>
                                                                </li>
                                                    ...
                                                    <div class="post-widget-item fl-wrap">
                                                        <div class="post-widget-item-media">
                                                            <a href="singlepost.html"><img src="images/all/thumbs/7.jpg" alt=""></a>
                                                        </div>
                                                        <div class="post-widget-item-content">
                                                            <h4><a href="singlepost.html">Tennis season
                                                                    still to
                                                                    proceed.</a></h4>
                                                            <ul class="pwic_opt">
                                                                <li><span><i class="far fa-clock"></i> 06 December
                                                                        2021</span></li>
                                                                <li><span><i class="far fa-comments-alt"></i> 05</span>
                                                                </li>
