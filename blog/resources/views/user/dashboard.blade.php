            ...
            <div class="col-xl-12">
                <div class="banner banner-color mt-0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <a href="#" class="btn btn-success mr-3">Deposit</a>
                        <a href="#" class="btn btn-primary">Reinvest Now</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-12 col-xl-8">
                                <div class="chart-wrapper">
                                    <canvas id="line-chart"
                                        class=" chartjs-render-monitor chart-dropshadow2 overflow-hidden"></canvas>
                                </div>
                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="card box-shadow-0 overflow-hidden">
                                            <div class="card-body p-4">
                                                <div class="text-center">
                                                    <i
                                                        class="fa fa-ticket fa-2x text-secondary text-secondary-shadow"></i>
                        ...
                        <div class="latest-timeline-1 activity-scroll mh-300">
                            <ul class="timeline-1 mb-0">
                                <li class="mt-0">
                                    ...
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">Task
                                        finished</a>
                                    <a href="#" class="float-right fs-12 text-muted">01 Jun, 2019</a>
                                    <p class="mb-0 mt-2 text-muted"><span class="text-primary font-weight-semibold">Adam
                                            Berry</span>
                                        finished task on<a href="#" class="text-info font-weight-semibold">
                                ...
                                <li class="mt-0">
                                    <i
                                        class="fe fe-message-square bg-secondary text-white product-icon secondary-dropshadow"></i>
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">New
                                        Comment</a>
                                    <a href="#" class="float-right fs-12 text-muted">05 Jun, 2019</a>
                                    <p class="mb-0 mt-2 text-muted"><span
                                            class="text-primary font-weight-semibold">Victoria</span>
                                        commented on Project <a href="#" class="text-info font-weight-semibold">
                                            AngularJS Template</a>
                                    </p>
                                </li>
                                <li class="mt-0">
                                    <i
                                        class="fe fe-alert-triangle bg-danger text-white product-icon danger-dropshadow"></i>
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">Task
                                        Overdue</a>
                                    <a href="#" class="float-right fs-12 text-muted">01 Jun, 2019</a>
                                    <p class="mb-0 mt-2"> Task the <span
                                            class="text-info font-weight-semibold">Wordpress Project</span>
                                        is on hold its takes longer than usual.</p>
                                    <div class="mt-2">
                                        <span class="badge badge-success-light">Bootstrap</span>
                                        <span class="badge badge-danger-light">HTML</span>
                                        <span class="badge badge-warning-light">Css</span>
                                ...
                                <li class="mt-0">
                                    ...
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">Task
                                        finished</a>
                                    <a href="#" class="float-right fs-12 text-muted">01 Jun, 2019</a>
                                    <p class="mb-0 mt-2"><span class="text-primary font-weight-semibold">Petey
                                            Cruiser</span>
                                        finished task <a href="#" class="text-info font-weight-semibold">
                                ...
                                <li class="mt-0">
                                    ...
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">Task
                                        finished</a>
                                    <a href="#" class="float-right fs-12 text-muted">01 Jun, 2019</a>
                                    <p class="mb-0 mt-2"><span class="text-primary font-weight-semibold">Manuel
                                            Labor</span>
                                        finished task <a href="#" class="text-info font-weight-semibold">
                                ...
                                <li class="mt-0 mb-0">
                                    ...
                                    <a target="_blank" href="#" class="font-weight-semibold mb-4 fs-15">Warren
                                        Peace</a>
                                    <a href="#" class="float-right fs-12 text-muted">01 Jun, 2019</a>
                                    <p class="mb-0 mt-2"><span class="text-primary font-weight-semibold">Adam
                                            Berry</span>
                                        commented on task <a href="#" class="text-info font-weight-semibold">
                                            AngularJS Template</a>
                                    </p>
                                </li>
                            </ul>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex  align-items-center">
                                        <h2 class=" mb-0">$3500.00<span class="font-weight-normal text-muted fs-13">/
                                                per
                                                month</span></h2>
                            ...
                            <div class="carousel-item carousel slide dashboard-carousel" data-ride="carousel">
                                <div class="card-body">
                                    ...
                                    <small class=""> Since last month</small>
                                    <div class="d-flex  align-items-center">
                                        <h2 class=" mb-0">23<span class="font-weight-normal text-muted fs-13">/
                                                per
                                                month</span></h2>
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0 pb-0">
                        ...
                        <div class="d-flex mb-4">
                            <div class="d-flex  align-items-center">
                                <h2 class="">$7450.40<span class="font-weight-normal text-muted fs-13">/ per
                                        month</span></h2>
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-6 text-center border-right">
                            ...
                            <span class="text-muted mb-0 fs-14"><span class="text-success mr-1"><i
                                        class="fe fe-arrow-up ml-1"></i>34.5%</span>increase</span>
                        </div>
                        <div class="col-6 text-center">
                            <div class="text-muted fs-14">Last Month Profit</div>
                            <div class="h3 mt-1 mb-0">36</div>
                            <span class="text-muted mb-0 fs-14"><span class="text-danger mr-1"><i
                                        class="fe fe-arrow-down ml-1"></i>34.5%</span>Decrease</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="card-body">
                                    ...
                                    <small class=""> Since last month</small>
                                    <div class="d-flex  align-items-center">
                                        <h2 class=" mb-0">45,981<span class="font-weight-normal text-muted fs-13">/ per
                                                month</span></h2>
                                        <div class="text-success mt-0 mb-2  ml-auto">
                            ...
                            <div class="carousel-item carousel slide dashboard-carousel" data-ride="carousel">
                                <div class="card-body">
                                    ...
                                    <small class=""> Since last month</small>
                                    <div class="d-flex  align-items-center">
                                        <h2 class=" mb-0">32,579<span class="font-weight-normal text-muted fs-13">/ per
                                                month</span></h2>
                                        <div class="text-danger mt-0 mb-2  ml-auto">
                            ...
                            <div class="row">
                                    ...
                                    <div class="clearfix mt-2">
                                        <div class="float-left">
                                            <div class="align-items-center">
                                                <h3 class=" mb-0">2154<span class="font-weight-normal text-muted fs-13">
                                                        / per
                                                        month</span></h3>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-sm-12 mt-3 mt-md-0">
                                    ...
                                    <div class="clearfix mt-2">
                                        <div class="float-left">
                                            <div class="align-items-center">
                                                <h3 class=" mb-0">950<span class="font-weight-normal text-muted fs-13">
                                                        /
                                                        active</span></h3>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-sm-12 mt-3 mt-md-0">
                                    ...
                                    <div class="clearfix mt-2">
                                        <div class="float-left">
                                            <div class="align-items-center">
                                                <h3 class=" mb-0">480<span class="font-weight-normal text-muted fs-13">
                                                        /
                                                        active</span></h3>
                                            </div>
                                        </div>
        ...
        <div class="row">
                ...
                <div class="card recent-leads">
                    ...
                    <div class="card-body">
                        <div class="media mt-0 pt-0 mb-5">
                            <img class="mr-3 avatar avatar-lg brround default-shadow" src="../assets/images/users/2.jpg"
                                alt="image">
                        ...
                        <div class="media mb-5">
                            <img class="mr-3 avatar avatar-lg brround default-shadow"
                                src="../assets/images/users/11.jpg" alt="image">
                            <div class="media-body">
                        ...
                        <div class="media mb-5">
                            <img class="mr-3 avatar avatar-lg brround default-shadow" src="../assets/images/users/5.jpg"
                                alt="image">
                            <div class="media-body">
                        ...
                        <div class="media mb-5">
                            <img class="mr-3 avatar avatar-lg brround default-shadow"
                                src="../assets/images/users/12.jpg" alt="image">
                            <div class="media-body">
                        ...
                        <div class="media">
                            <img class="mr-3 avatar avatar-lg brround default-shadow" src="../assets/images/users/6.jpg"
                                alt="image">
                            <div class="media-body">
            ...
            <div class="col-lg-6 col-xl-4 col-sm-12">
                <div class="card overflow-hidden">
                    <div class="">
                        <div class="text-center">
                            <img src="../assets/images/media/project-1.jpg" alt="img" class="h-200 w-100">
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="list-group projects-list">
                            ...
                            <a href="#"
                                ...
                                <div class="d-flex w-100 justify-content-between">
                                    ...
                                    <small class="text-success"><i class="fa fa-caret-up mr-1"></i>10 days
                                        ago</small>
                                </div>
