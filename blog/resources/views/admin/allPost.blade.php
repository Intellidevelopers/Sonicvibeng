                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button
                                                class="btn btn-warning text-white">{{strtoupper($trend->status)}}</button>
                                            @else
                                            <button
                                                class="btn btn-success text-white">{{strtoupper($trend->status)}}</button>
                                            @endif
                                        </td>
                                        <td>{{$trend->created_at}}</td>
                                        <td>
                                            <a href="{{route('edit.post',$trend->id)}}"
                                                class="btn btn-primary text-white"><i class="fa fa-edit"></i></a>
                                            <a href="{{route('delete.post',$trend->id)}}"
