        ...
        <main class="main">
            <div class="intro-slider-container mb-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" 
                    ...
                    <div class="intro-slide" style="background-image: url(assets/images/slider/slide-2.png);">
                    ...
                    <div class="intro-slide" style="background-image: url(assets/images/slider/slide-22.jpg);">
                        <div class="container intro-content">
                            <div class="row justify-content-end">
                                <div class="col-auto col-sm-7 col-md-6 col-lg-5">
                                    <h3 class="intro-subtitle text-primary">New Arrival</h3><!-- End .h3 intro-subtitle -->
                                    <h1 class="intro-title text-white">Apple iPad Pro <br>12.9 Inch, 64GB </h1><!-- End .intro-title -->
                ...
                <div class="cat-blocks-container">
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="{{url('category',$prod->category->category_name)}}" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{asset('products/'.$prod->image)}}" alt="Category image">
                                    </span>
                                </figure>

                                <h3 class="cat-block-title">{{$prod->title}}</h3><!-- End .cat-block-title -->
                            </a>
                ...
                <div class="heading heading-flex mb-3">
                   ...
                   <div class="heading-right">
                        <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="new-watches-link" data-toggle="tab" href="#new-watches-tab" role="tab" aria-controls="new-watches-tab" aria-selected="false">Electronics</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="product product-2">
                                <figure class="product-media">
                                    @if($product->status == "New")
                                        <span class="product-label label-circle label-new">{{$product->status}}</span>
                                    @elseif($product->status == "Top")
                                        <span class="product-label label-circle label-top">{{$product->status}}</span>
                                    @elseif($product->status == "Out of stock")
                                        <span class="product-label label-circle label-out">{{$product->status}}</span>
                                    @elseif($product->status == "Top sale")
                                    ...
                                    <a href="{{url('product/'.$product->slug)}}">
                                        <img src="{{asset('products/'.$product->image)}}" alt="Product image" class="product-image">
                                    </a>
                                    ...
                                    <div class="product-action">
                                       <a href="{{url('product',$product->slug)}}" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a>
                                ...
                                <div class="product-body">
                                    <div class="product-cat">
                                        <a href="{{url('product/'.$product->slug)}}">{{$product->category->category_name}}</a>
                                    </div><!-- End .product-cat -->
                                    <h3 class="product-title"><a href="{{url('product/'.$product->slug)}}">{{$product->title}}</a></h3><!-- End .product-title -->
                                    ...
                                    <div class="ratings-container">
                                        ...
                                        <span class="ratings-text">( {{$product->quantity}} Available )</span>
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-1.jpg');">
                            ...
                            <div class="deal-content">
                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Home Smart Speaker with  Google Assistant</a></h3><!-- End .product-title -->
                                ...
                                <a href="{{url('product',$product->slug)}}" class="btn btn-link"><span>Shop Now</span><i class="icon-long-arrow-right"></i></a>
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-2.jpg');">
                            ...
                            <div class="deal-content">
                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Certified Wireless Charging  Pad for iPhone / Android</a></h3><!-- End .product-title -->
                                    ...
                                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Apple - 11 Inch iPad Pro  with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $899.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Bose - SoundLink Bluetooth Speaker</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $79.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Google - Pixel 3 XL  128GB</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Samsung - 55" Class  LED 2160p Smart</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $899.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Apple Watch Series 4 Gold Aluminum Case</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $499.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Bose - SoundSport  wireless headphones</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $199.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('product',$product->slug)}}">Microsoft - Refurbish Xbox One S 500GB</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $279.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                ...
                <div class="products">
                    <div class="row justify-content-center">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-price">
                                        ...
                                        <span class="old-price">Was  ${{number_format($product->discount_price)}}</span>
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                                        <div class="ratings">
                        ...
                        <div class="col-md-12 col-12">
                            {!!$recommended->withQueryString()->links('pagination::bootstrap-5')!!}
                        </div>
                    </div><!-- End .row -->
                </div><!-- End .products -->
            </div><!-- End .container -->
